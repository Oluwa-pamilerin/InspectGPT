        ...
        <div class="chat-container">
            ...
            document.addEventListener('DOMContentLoaded', () => {
              ...
              textareaEle.addEventListener('input', () => {
                ...
                const getChatResponse = async (incomingChatDiv, inputText) => {
                ...
                const handleOutgoingChat = () => {
                    ...
                    const html = "<div class='chat-content'><div class='chat-details'><img src='https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Visual_Studio_Code_1.35_icon.svg/512px-Visual_Studio_Code_1.35_icon.svg.png' alt='user-img' style='border-radius:100%; width: 30px; height: 30px;'><p>"+ userText +"</p></div></div>";
                ...
                function handleInput(text, callback, content = "") {
                  console.log("HandleInputCalledUpHere")
                    vscode.postMessage({
                        command: "handleInput",
                        text: text,
                        content: content,
                ...
                window.addEventListener("message", function (event) {
                    if (event.data.command === "handleInputResult") {
                      // getChatResponse('', event.data.result)
                      appendMessage("bot", event.data.result);
                      console.log('Result From Window Event: ' + event.data.result);
                    }
                });
...
function handleMessage(message) {
  ...
  if (message.command === "handleInput") {
    // content
    // messages
    console.log("HandleInputCommandCalled");
